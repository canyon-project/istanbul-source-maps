...
print_info "https://github.com/canyon-project/istanbul-source-maps/actions"

print_info "发布完成后，用户可以通过以下命令安装:"
echo -e "${GREEN}go get github.com/canyon-project/istanbul-source-maps/go@$VERSION${NC}"